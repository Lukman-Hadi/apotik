			...
			<div class="col-md-12">
				<div class="card card-primary">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-6">
								<a href="<?= base_url() . 'export/exportStokBarangKeluar?start=' . $start . '&end=' . $end ?>" class="btn btn-info btn-rounded">Export Excel</a>
								<a href="<?= base_url() . 'cetak/laporanbarangkeluar?start=' . $start . '&end=' . $end ?>" target="_blank" class="btn btn-secondary btn-neutral">Print</a>
							</div>
							<div class="col-6">
