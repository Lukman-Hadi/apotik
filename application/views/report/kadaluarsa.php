			...
			<div class="col-md-12">
				<div class="card card-primary">
					...
					<div class="card-body">
						...
						<a href="<?= base_url() . 'cetak/laporankadaluarsa' ?>" target="_blank" class="btn btn-secondary btn-neutral">Print</a>
					</div>
				</div>
			</div>
		</div>
...
<script>
	$(document).ready(function() {
		...
		const table = $('#tbl-barang').DataTable({
			...
			ajax: {
				url: "getKadaluarsa", // URL file untuk proses select datanya
				type: "POST"
			},
			columns: [{
					data: "kode_barang",
